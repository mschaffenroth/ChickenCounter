...
if __name__ == '__main__':
    ...
    parser.add_argument('--max-fps', default='100', help='restrict fps number')
    parser.add_argument('--broker-topic', default='v1/devices/chicken_counter/telemetry', help='publish results to mqtt topic / topic')
    parser.add_argument('--broker-url', default='localhost', help='publish results to mqtt topic / url')
    parser.add_argument('--broker-port', default='1883', help='publish results to mqtt topic / port')
    parser.add_argument('--broker-username', default='chicken_counter', help='publish results to mqtt topic / username')
    parser.add_argument('--broker-password', default='', help='publish results to mqtt topic / password')
